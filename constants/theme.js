...
export const FONT = {
  largeTitlestyle: { fontFamily: "Poppins-Black", fontSize: SIZE.largeTitle },
  h1style: { fontFamily: "Poppins-Bold", fontSize: SIZE.h1, lineHeight: 36 },
  h2style: { fontFamily: "Poppins-Bold", fontSize: SIZE.h2, lineHeight: 30 },
  h3style: { fontFamily: "Poppins-SemiBold", fontSize: SIZE.h3, lineHeight: 22 },
  h4style: { fontFamily: "Poppins-SemiBold", fontSize: SIZE.h4, lineHeight: 22 },
  h5style: { fontFamily: "Poppins-SemiBold", fontSize: SIZE.h5, lineHeight: 22 },
  body1style: {
...
export default apptheam = { COLORS, SIZE ,FONT};
